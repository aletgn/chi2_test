...
def compute_chi2(bins, counts, rand_var):
    ...
    ----------
    bins : np array
        array of bins with structured given in unravel_bins.
    counts : np array
        array of observed frequencies.
    rand_var : scipy random varible
        random variable generated by build_rv.

    Returns
    -------
    FLOAT
        The value of the test statistics U. See README.md.
